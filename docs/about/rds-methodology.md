...
- **[RDS Analyst](http://www.hpmrg.org/rds_analyst/)** — Free software developed by the original RDS research group. Supports Volz-Heckathorn and other estimators.
- **[RDS R package](https://cran.r-project.org/package=RDS)** — Open-source R package for RDS estimation and visualization.
...
- [CDC: Respondent-Driven Sampling](https://www.cdc.gov/hiv/risk/ssdu/respondent-driven-sampling.html)
